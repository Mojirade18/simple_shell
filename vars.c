...
/**
 * is_chain_delimiter - checks if the current character in the buffer is a command chain delimiter
...
/**
 * check_chain_continue - checks if we should continue chaining based on the last command's status
 * @info: the parameter struct
 * @buf: the character buffer
 * @p: address of the current position in buf
